...
const Testimonials = () => {
  const testimonials = [
    {
      ...
      text: "The team made me feel comfortable and confident. Every picture turned out natural, elegant, and truly unforgettable memories",
      rating: 5,
    },
    {
      name: "Ganesh Panday",
      role: "Business Owner",
      text: "Amazing experience from start to finish. The photos beautifully captured every detail, making my special day even more magical.",
      rating: 5,
    },
    {
      name: "Sneha Patel",
      role: "Product Designer",
      text: "Professional, creative, and supportive throughout the shoot. They turned simple moments into timeless memories with stunning quality results",
      rating: 5,
    },

    {
      name: "Jaya Shah",
      role: "Event Planner",
      text: "Working with this team was an absolute pleasure. They delivered well beyond our expectations!",
      rating: 5,
    },
    {
      name: "Suraj Kumar",
      role: "Actor",
      text: "Their headshots are incredible. They have a unique ability to capture personality in every frame.",
      rating: 5,
    },
  ];
  ...
  const getVisibleTestimonials = () =>
    [0, 1, 2].map(
      (i) => testimonials[(currentIndex + i) % testimonials.length],
    );
  ...
  const TestimonialCard = ({ t, featured = false }) => (
    ...
    >
      {/* Top accent bar */}
      <div
        className={`absolute top-0 left-0 w-full h-1 bg-red-600 transition-transform duration-500 origin-left
      ...
      <div className="border-t border-gray-100 pt-5 flex items-center gap-4">
        {/* Avatar */}
        <div
          className={`w-12 h-12 rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0 transition-colors duration-300
