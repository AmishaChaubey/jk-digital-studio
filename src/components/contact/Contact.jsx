...
export default function ContactPage() {
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Call Us",
      detail: "+91 9990607660",
      sub: "Available 24/7",
      href: "tel:+919990607660",
    },
    {
      icon: Mail,
      title: "Email Us",
      detail: "jaikaran326@gmail.com",
    ...
    },
    {
      icon: MapPin,
      title: "Visit Studio",
      detail: "Nav durga Mandir, Nirala Greenshire, ",
      sub: "Sector 2, Noida, UP",
      href: "#map",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, we specialize in wedding photography, capturing candid and traditional moments beautifully.",
    },
    {
      question: "How can I book a session?",
      answer:
        "You can contact us through our website's contact form or directly via phone/email.",
    },
    {
      question: "Do you offer customized photo packages?",
      answer:
        "Absolutely! We provide packages tailored to your needs and budget.",
    },
    {
      question: "Can you handle live telecast services for events?",
      answer:
        "Yes, we specialize in live telecasting your events — be it weddings, corporate events, or cultural programs.Using advanced broadcast tools, we ensure your audience, near or far, can experience your event in real-time with high-quality streaming.",
    },
    {
      question: "How far in advance should I book JK Digital Photo Studio?",
      answer:
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      {/* Hero Banner */}
      <div className="relative min-h-screen sm:h-[65vh] flex items-center justify-center overflow-hidden">
        <div
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-900 leading-snug group-hover:text-red-600 transition-colors duration-300">
                    {info.detail}
                  </p>
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl shadow-lg p-6 sm:p-8 relative overflow-hidden">
            ...
            <div className="mb-7">
              <p className="text-red-600 text-xs font-bold uppercase tracking-[0.2em] mb-1">
                Contact Form
              </p>
              <h2
            ...
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <button
                  ...
                  className="mt-5 text-red-600 text-sm font-semibold hover:underline"
                >
          ...
          <div id="map" className="flex flex-col gap-4">
            <div className="relative rounded-2xl overflow-hidden shadow-lg border border-gray-100 flex-1 min-h-[300px]">
              ...
              <iframe
                title="Studio Map"
                className="w-full h-full min-h-[300px]"
                src="https://www.google.com/maps?q=Nav+Durga+Mandir,+Nirala+Greenshire,+Sector+2,+Noida,+UP&output=embed"
                allowFullScreen=""
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
              ></iframe>
            ...
            <div className="grid grid-cols-2 gap-4">
              <a
                href="tel:+919990607660"
                className="group bg-red-600 hover:bg-red-700 rounded-2xl p-4 flex items-center gap-3 transition-all duration-200 active:scale-95"
              >
                ...
                <div>
                  ...
                  <p className="text-white font-bold text-sm">+91 9990607660</p>
                </div>
              </a>
              <a
                href="https://wa.me/919990607660"
                target="_blank"
                rel="noreferrer"
                className="group bg-gray-900 hover:bg-gray-800 rounded-2xl p-4 flex items-center gap-3 transition-all duration-200 active:scale-95"
              >
      ...
      <div className="bg-gray-50 py-14 sm:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="font-semibold text-sm leading-snug mt-4 px-18 text-gray-500">
              Have a different question and can’t find the answer you’re looking
              for? Reach out to our support team by sending us an email and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <h3
                    className={`font-semibold text-sm leading-snug transition-colors duration-200 ${openFaq === index ? "text-red-600" : "text-gray-800"}`}
                  >
                    {faq.question}
                  </h3>
                  <div
                    className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 ${openFaq === index ? "bg-red-600" : "bg-gray-100"}`}
                  >
                    <ChevronDown
                      className={`w-4 h-4 transition-transform duration-300 ${openFaq === index ? "rotate-180 text-white" : "text-gray-500"}`}
                    />
                  </div>
                </button>
                <div
                  className={`px-5 transition-all duration-300 overflow-hidden ${openFaq === index ? "max-h-40 pb-5 opacity-100" : "max-h-0 opacity-0"}`}
                >
